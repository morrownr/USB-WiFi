...
Summary: The Golden Rules to help you find USB WiFi Adapter(s) that meets your needs
...
- Avoid multi-function adapters. Some usb wifi adapters also have bluetooth capability. You do not want this! I have seen many problems with this over the years and bluetooth will likely limit the wifi to USB2 speeds. If you need bluetooth capability, go get a seaparate bluetooth adapter or a PCIe card such as the ones based on the mt7922 chipset.
...
- Avoid products by certain companies as they make things difficult for Linux users. See paragraph earlier in this document for details and avoid TP-Link products.
