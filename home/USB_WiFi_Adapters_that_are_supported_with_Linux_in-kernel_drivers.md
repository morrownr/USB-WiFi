...
Info: Be aware that the range of the 6 GHz band has been reduced similar to what happened when the 5 GHz band became available. So, while 6 GHz may have a big pipeline, it will have less range than 5 GHz. Another issue you need to be aware of is that wifi routers vary in how they handle clients. It is best that you pick a wifi router that gives you the ability to set different names for all 3 bands so that you can control which band you are connected to.
...
Amazon - 70 USD - [NETGEAR AC1200 Wi-Fi USB Adapter High Gain Dual Band USB 3.0 (A6210)](https://www.amazon.com/NETGEAR-AC1200-Wi-Fi-Adapter-A6210-100PAS/dp/B00MRVJY1G)
...
Amazon - $8 USD - [Mini 150m USB Wifi Wireless Network Card](https://www.amazon.com/Wireless-Network-802-11-Adapter-Antenna/dp/B008Z9IZSW)
