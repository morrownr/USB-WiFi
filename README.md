...
Note: Linux distros that are regularly used to test many of these adapters include Kali, Ubuntu, Mint, Raspberry Pi OS, Raspberry Pi Desktop (x86), Manjaro, Fedora and Debian. 
