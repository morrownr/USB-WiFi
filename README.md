...
What's new? The section about Realtek out-of-kernel drivers near the end of this document has been updated.
...
Note: The link immediately following this line is a short quick reference list that does not include online links to the products, reviews or reference to all of the available adapters so it is recommended that you read the entire document:
